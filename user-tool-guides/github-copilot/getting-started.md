...
Use the following steps if you work in Visual Studio Code.
...
Use the following steps if you work in IntelliJ IDEA, PyCharm or another JetBrains IDE.
...
Once Copilot is set up, start using it to generate code.
